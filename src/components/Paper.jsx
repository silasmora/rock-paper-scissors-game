...
const Paper = ({playerSelection, setPlayerSelection}) => {
  
  return (
    <div className={`${playerSelection === null ? 'absolute top-0 left-0 transform -translate-x-1/2 -translate-y-1/2' : 'md:h-52 md:w-52'}

    cursor-pointer
    bg-gradient-to-b from-paperPrimary to-paperSecondary rounded-full h-32 w-32 flex items-center justify-center sm:h-36 sm:w-36 md:h-44 md:w-44`} 
      onClick={() => setPlayerSelection('paper')}
      style={{
        boxShadow: '1px 3px 0px 2px rgba(33, 65, 180, 0.25)'
      }}
      >
